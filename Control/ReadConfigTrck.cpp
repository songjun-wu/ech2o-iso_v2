...
int Control::ReadConfigTrck(string confilename /*= "configTrck.ini"*/)
{
  ...
  try{
    ...
    if(sw_2H){
      ...
      Rep_d2HSrftoChn = ConfigTrck.read<bool>("Rep_d2HSrftoChn"); //yangx 2022-05
      ...
      RepTs_d2HSrftoChn = ConfigTrck.read<bool>("Ts_d2HSrftoChn"); //yangx 2022-05
    ...
    if(sw_18O){
	  ...
	  Rep_d18OSrftoChn = ConfigTrck.read<bool>("Rep_d18OSrftoChn"); // yangx 2022-05
	  ...
	  RepTs_d18OSrftoChn = ConfigTrck.read<bool>("Ts_d18OSrftoChn"); // yangx 2022-05
