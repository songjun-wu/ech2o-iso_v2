...
int Control::ReadConfigFile(string confilename /*= "config.ini"*/)
{
	...
	//yangx 2022-05
	sw_partial_reinf = Config.read<bool>("Channelcell_partial_reinfiltration");
    ...
    sw_couple =  Config.read<bool>("External_Coupling");
    ...
    toggle_SrfOVFmix = Config.read<int>("SrfOVFmix_mode");
    ...
    if (toggle_SrfOVFmix == 1){
	  Config.readInto(fn_ratiosrfmix,"overlandflow_mixing_ratio");
    }
