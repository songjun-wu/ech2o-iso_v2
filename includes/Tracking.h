...
class Tracking {
  ...
  grid *_d2HSrftoChn,  *_d18OSrftoChn, *_AgeSrftoChn; // Srf overland flow
 ...
 public:
  ...
  void MixingChannel_CRunoff(Basin &bsn, Control &ctrl,
  ...
  void MixingV_latupDGW(Basin &bsn, Control &ctrl, 
			     double &d1, double &d2, double &d3, double &fc,
			     double &Qk1, double &dtdx, double &dx, double &dt, int r, int c);
  void MixingChannel_CRunoffDGW(Basin &bsn, Control &ctrl,
			    double &poros1, int r, int c);
  void FCdownstream_DGW(Basin &bsn, Control &ctrl,
			    double &Qk1, double &dtdx, double &dx, int r, int c, int rr, int cc);
  void OutletVals_DGW(Basin &bsn, Control &ctrl, int mode, 
                   double Qk1, double Outletpond, int r, int c);
  
  void PrefluxTrck_DGW(Control &ctrl);
  
  int IncrementAge_DGW(Basin &bsn, Control &ctrl);
