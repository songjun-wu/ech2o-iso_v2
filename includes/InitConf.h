...
struct Control{
  ...
  bool sw_partial_reinf; //swith to turn on and off the partial re-infiltration for channel cells
  //yangx 2020-05
  ...
  //yangx 2022-01
  bool sw_couple; //switch to turn on and off writing out all states/fluxes for external coupling
  ...
  int toggle_SrfOVFmix; // choose Surface overland mixing mode with top-layer soil water 
  ...
  string fn_ratiosrfmix; //surface overland flow tracer mixing ratio
