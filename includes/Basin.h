...
class Basin {
  ...
  grid *_fieldcapL1, *_fieldcapL2, *_fieldcapL3; //field capacity (volumetric)
  grid *_Wiltingpnt; //gridwise wilting point, weighted by species areas(volumetric) 
  ...
  grid *_Transpiration_L1; //transpiration from canopy in m s-1
  grid *_Transpiration_L2; //transpiration from canopy in m s-1
  grid *_Transpiration_L3; //transpiration from canopy in m s-1



  grid *_BedrockLeakageFlux; //water flux down the bottom of the soil in m s-1
  grid *_BedrockLeakageDepth; //water flux down the bottom of the soil in m --yangx 2022
  ...
  grid *_FluxSrftoL1; // infiltration from first layer (changes twice during time step)//changed by yangx 2022-01
  ...
  //if reinfiltration allowed then additionally store vertical fluxes for external coupling
  // yangx 2022-01
  grid *_FluxSrftoL1_r; // infiltration from first layer
  grid *_FluxInfilt_r; // timestep-summed infiltration from first layer
  grid *_FluxL1toL2_r; // percolation L1 to L2
  grid *_FluxL2toL3_r; // percolation L2 to L3
  ...
  grid *_FluxSrftoChn; // overland flow to channe
  //added by yangx 2022
  grid *_Srfmixratio; //overland flow tracer mixing ratio 
  ...
  grid *_QLattoChn; //_FluxLattoChn in m^3/s
  grid *_QChntoLat; //_FluxChntoLat in m^3/s
  grid *_QChanstore; //_FluxChntoLat in m^3
  ...
  void Infilt_GreenAmpt(Control &ctrl, double &f, double &F, double &theta, double &theta2,
			double &theta3, double &pond, double &gw, double dt, int r, int c, int step);
...
#pragma omp parallel for			\
  ...
  grid *getTranspiration_L1() const {
    return _Transpiration_L1;
  }
  grid *getTranspiration_L2() const {
    return _Transpiration_L2;
  }
  grid *getTranspiration_L3() const {
    return _Transpiration_L3;
  }
  grid *getBedrockLeakage() const{
    return _BedrockLeakageFlux;
  }
  grid *getBedrockLeakage_Depth() const{
    return _BedrockLeakageDepth;
  }
  ...
  grid *getFluxSrftoL1R() const {
    return _FluxSrftoL1_r;
  }
  grid *getFluxInfiltR() const {
    return _FluxInfilt_r;
  }
  ...
  // yangx 2022-01
  grid *getChanUpin() const {
    return _QLattoChn;
  }
  grid *getChanDownout() const {
    return _QChntoLat;
  }
  grid *getChanstoreV() const {
    return _QChanstore;
  }
  ...
  grid *getFluxL1toL2R() const {
    return _FluxL1toL2_r;
  }
  grid *getFluxL2toL3R() const {
    return _FluxL2toL3_r;
  }
