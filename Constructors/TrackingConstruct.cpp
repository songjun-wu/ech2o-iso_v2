...
/*   _d2HExtraGWtrOutput = NULL;
  ...
  try{
    if(ctrl.sw_2H){
      ...
      _d2HSrftoChn = new grid(ctrl.path_BasinFolder + ctrl.fn_d2Hsurface, ctrl.MapType);
    ...
    if(ctrl.sw_18O){
      ...
      _d18OSrftoChn = new grid(ctrl.path_BasinFolder + ctrl.fn_d18Osurface, ctrl.MapType);
